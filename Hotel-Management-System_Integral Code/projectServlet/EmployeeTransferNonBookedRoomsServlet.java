...
public class EmployeeTransferNonBookedRoomsServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Renting transferRentingResult = ae.nonBookedToRenting(customerSIN,hotelAddress,roomNumber,employeeSIN,payment,startDate,endDate);
        ...
        if(transferRentingResult == null){                                                  //go back to original page
            ...
            request.getRequestDispatcher("EmployeeCheckAvailableRooms.jsp").forward(request,response);
            ...
            response.sendRedirect("EmployeeTransferNonBookedRoomsResult.jsp");
        }
        ae.close();
        return;
    }
